...
Array = Bools | Ints | Floats | Decs | Strs | Paths
Array2 = Bools2 | Ints2 | Floats2 | Decs2 | Strs2 | Paths2
Pair = BoolPair | IntPair | FloatPair | DecPair | StrPair | PathPair
Pair2 = BoolPair2 | IntPair2 | FloatPair2 | DecPair2 | StrPair2 | PathPair2
Single = None | bool | int | float | Decimal | str | Path
